...
\supervisor[Co-promotor]{N. Jacobs (Faresa, \href{mailto:nele.jacobs@faresa.be}{nele.jacobs@faresa.be}), K. Van den Broeck (akompanje, \href{mailto:info@akompanje.com}{info@akompanje.com})}
