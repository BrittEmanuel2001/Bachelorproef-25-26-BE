...
\usepackage{pifont}
\newcommand{\vink}{\ding{51}}
\newcommand{\kruis}{\ding{55}}
\newcommand{\ster}{\ding{72}}
...
\newacronym{who}{WHO}{Wereldgezondheidsorganisatie}
...
\newacronym{ov}{OV}{Online Vigilance}
\newacronym{rebt}{REBT}{Rational Emotive Behavior Therapy}
\newacronym{cbt}{CBT}{Cognitive Behavioral Therapy}
\newacronym{ehealth}{e-health}{electronic health}
\newacronym{mhealth}{m-health}{mobile health}
...
\newacronym{smarter}{SMARTER}{Specifiek Meetbaar Acceptabel Realistisch Tijdsgebonden Evaluate Review}
...
\cosupervisor{Mevr. K. Van den Broeck}
...
\begin{document}
    ...
    \chapter{Interview requirements-analyse}
    \label{ch:interview-requirementsanalyse}
    
    \input{../bijlagen/interview-vragen}
