...
Om het onderzoek zo succesvol mogelijk te laten verlopen, werd ervoor gekozen het op te splitsen in zes fasen. De eerste fase werd reeds doorlopen: de probleemverkenning, waarin een literatuurstudie wordt uitgevoerd om meer inzicht te krijgen in het probleemdomein. Daarnaast werd er in deze fase een inventarisatie gemaakt van het huidige aanbod van burn-outbestrijdingsproducten, de zogenaamde longlist-fase. Vervolgens staat het uitvoeren van een requirements-analyse op de planning, resulterend in een lijst van beoordelingscriteria. Eenmaal deze criteria in kaart zijn gebracht, worden de apps uit de longlist herleid tot een shortlist door middel van een beoordeling op basis van deze beoordelingscriteria. Vervolgens is het tijd om de \acrlong{poc} op te stellen. In deze fase worden mock-ups ontwikkeld en uiteindelijk een werkend prototype gerealiseerd. Tot slot wordt in de conclusiefase het succes van dit werkende prototype bepaald door middel van een heuristische evaluatie.
...
Gedurende de eerste fase was het de bedoeling een diepgaand begrip te krijgen van het probleemdomein aan de hand van een \textbf{literatuurstudie}. Voor dit onderzoek was het essentieel te begrijpen wat een burn-out precies inhoudt, hoe dit speelt bij de huidige generatie twintigers, welke rol digitalisering en een verhoogde cognitieve belasting hierbij kunnen spelen, en welke preventie- en behandelingsstrategieën momenteel beschikbaar zijn. 

\vspace{1em}

Vervolgens werd het huidige aanbod aan digitale oplossingen voor mentale gezondheid onderzocht, met aandacht voor hun effectiviteit en mogelijke tekortkomingen. Daarbij werden ook UX- en ontwerpprincipes die bijdragen aan mentale rust onder de loep genomen. Tot slot werd gekeken naar de bestaande technologieën in de app-ontwikkelingswereld, zodat de meest geschikte technologie kan worden geselecteerd voor de ontwikkeling van de proof-of-concept.

\vspace{1em}

Het resultaat van deze fase was een beknopt overzicht van de oorzaken van burn-out bij twintigers, hun belangrijkste risicofactoren, en een eerste inventaris van bestaande preventie- en behandelingsstrategieën.
