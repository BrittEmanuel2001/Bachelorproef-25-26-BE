...
\begin{figure}[H]
    ...
    \begin{minipage}{0.3\textwidth}
        \centering
        \includegraphics[width=\linewidth]{../graphics/Code/PoC25}
    \end{minipage}
    \hfill
    \begin{minipage}{0.3\textwidth}
        \centering
        \includegraphics[width=\linewidth]{../graphics/Code/PoC26}
    \end{minipage}
    \hfill
    \begin{minipage}{0.3\textwidth}
        \centering
        \phantom{\includegraphics[width=\linewidth]{../graphics/Code/PoC26}}
    \end{minipage}
    
    \caption{Meldingen voor het toestaan van notificaties en de alert die wordt weergegeven wanneer notificaties worden geweigerd.}
    \label{fig:code-ss-5}
\end{figure}