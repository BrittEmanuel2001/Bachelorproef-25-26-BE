...

{
    ...
    \begin{longtable}{
        ...
        \begin{itemize}[nosep,leftmargin=*,itemsep=10pt]
            \renewcommand{\labelitemi}{-}
            \item De startpagina bevat meerdere mogelijke acties, waardoor het minder duidelijk is welke functionaliteit de gebruiker best eerst gebruikt.
            ...
            \item Het icoon rechtsboven voor instellingen is niet onmiddellijk herkenbaar als instellingenmenu.
            \item Bij oefeningen is de primaire actie niet direct zichtbaar, waardoor gebruikers eerst moeten ontdekken dat ze naar beneden moeten scrollen om de startknop te vinden.
        \end{itemize}
        \\
