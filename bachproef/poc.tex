...
In de vorige versie van de applicatie was er geen mogelijkheid om een persoonlijk profiel aan te maken. Hierdoor kon de gebruiker geen eigen naam, doel, ... instellen, wat de applicatie minder persoonlijk maakte. In de nieuwe versie werd daarom een profielpagina toegevoegd die personalisatie en het zichtbaar maken van persoonlijke vooruitgang ondersteunt. Het aanmaken van een account blijft hierbij niet verplicht.
...
{\small
    \begin{itemize}
        ...
        \item \textit{Jouw groeimomenten} maakt kleine vooruitgangen zichtbaar via laagdrempelige badges, waardoor ook kleine successen worden erkend (\textbf{Ontwerpprincipes}: \textit{betekenisvolle, prestatievrije motivatie}).
    \end{itemize}
}
