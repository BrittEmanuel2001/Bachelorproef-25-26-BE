...
\begin{figure}[H]
    ...
    \begin{minipage}{0.3\textwidth}
        \centering
        \phantom{\includegraphics[width=\linewidth]{../graphics/Mockups/Ontwikkeling/Ontwikkeling_samenOpPad_4}}
    \end{minipage}
...
{\small
    \begin{itemize}
        ...
        \item Het aantal activiteiten waarop een gebruiker kan reageren wordt beperkt om een eindeloze contentfeed en overmatig scrollen te vermijden (\textbf{Ontwerpprincipes}: \textit{beperk digitale interrupties, minimaliseer cognitieve belasting}).
...
\begin{figure}[H]
    ...
    \caption{Mockups van cursusinhoud en expertcontent binnen de kennishoek}
