...
De synthese van dit interview leidde tot de volgende cruciale pijlers die de verdere bepaling van de functionele en niet-functionele requirements zullen sturen:
...
\begin{itemize}
    ...
    \item \textbf{Fase-gebaseerde content (Chunking):} De interventie moet stapsgewijs verlopen om information overload te vermijden. Dit kan bijvoorbeeld voor secondaire burn-out preventie door eerst de focus te leggen op 'leren remmen' (ademhaling, zintuiglijke oefeningen) en psycho-educatie (over het belang van rust, slaap en het luisteren naar lichamelijke signalen). Pas bij voldoende fysieke rust schakelt de app over naar cognitieve reflectie over de oorzaken. Echter wordt de focus gelegd op secundaire preventie van chronische overspanning en zal dit een andere vorm kunnen krijgen.
    ...
    \item \textbf{Personalisatie van notificaties:} Om te vermijden dat de app als een extra 'verplichting' aanvoelt of bijkomende overprikkeling van het zenuwstelsel veroorzaakt, moeten notificaties instelbaar zijn op basis van de individuele behoefte en de mate van smartphonegebruik van de gebruiker.
\end{itemize}
...
zodat \textit{ik inzicht krijg in chronische overspanning, het zenuwstelsel en coping}.
...
Als \textbf{gebruiker}, \newline
wil ik \textbf{zachte beloningen/bevestigingen ontvangen}, \newline
...

{
    ...
    \begin{longtable}{
        ...
        \begin{itemize}
            ...
            \item Instelbare minimale tijd tussen meldingen om onderbrekingen te beperken en rust te waarborgen
...

{
    ...
    \begin{longtable}{
        ...
        \begin{itemize}
            \item Voorzie beloningen gekoppeld aan betekenisvolle acties en vooruitgang (zowel bij merkbare als bij kleinere of laagdrempelige stappen)
