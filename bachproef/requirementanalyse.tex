...
TODO aanvullen van ontwerpprincipes
...

{
    ...
    \begin{longtable}{
        ...
        \toprule
        \textbf{Principe} & \textbf{Toepassing} & \textbf{Theorie} \\
        \midrule
        \endfirsthead
...

{
    ...
    \begin{longtable}{
        ...
        %==============================
        {1. Minimaliseer cognitieve belasting}
        &
        \begin{minipage}[t]{\hsize}
            \raggedright
            \begin{itemize}[nosep, leftmargin=*]
                \item Beperk elke pagina tot één primaire actie
                \item Splits inhoud op in kleine stappen (\textit{chunking})
                \item Gebruik voldoende witruimte tussen secties
                \item Maak gebruik van progressive disclosure
                \item Vermijd overbodige elementen en tekst (\textit{MoSCoW prioritering})
            \end{itemize}
        \end{minipage}
        &
        Sectie 0.0.0
        ...
        {2. Vermijd visuele overprikkeling}
        &
        \begin{minipage}[t]{\hsize}
            \raggedright
            \begin{itemize}[nosep, leftmargin=*]
                \item Vermijd sterk gesatureerde kleuren en sterke contrasten zonder functioneel doel
                \item Gebruik accentkleuren uitsluitend voor interacties en statusfeedback
                \item Vermijd decoratieve animaties
                \item Gebruik afbeeldingen en video alleen ter ondersteuning van informatie
                \item Houd een consistente visuele stijl aan (\textit{spacing, typografie en soorten components})
            \end{itemize}
        \end{minipage}
        &
        Sectie 0.0.0
...

{
    ...
    \begin{longtable}{
        ...
        %==============================
        1. Bevorder gebruikersautonomie &
        \begin{minipage}[t]{\hsize}
            \raggedright
            \begin{itemize}[nosep, leftmargin=*]
                \item Geef gebruikers controle over doelen
        ...
        \begin{minipage}[t]{\hsize}
            \raggedright
            \begin{itemize}[nosep, leftmargin=*]
                \item Geef directe en positieve feedback na acties
                \item Vermijd complexe/dubbelzinnige instructies
                \item Formuleer instructies helder en stap-voor-stap
            \end{itemize}
        \end{minipage}
        &
        Sectie 0.0.0
        ...
        3. Stimuleer verbondenheid &
        \begin{minipage}[t]{\hsize}
            \raggedright
            \begin{itemize}[nosep, leftmargin=*]
                \item Bied mogelijkheden om ervaringen te delen
                \item Ondersteun communicatie met peers
                \item Ondersteun communicatie met experts
            \end{itemize}
        \end{minipage}
        &
        Sectie 0.0.0
